...
main <- function(cfg, target_date){
  ...
  if (isTRUE(model$maxent)) {
    ...
    summary_row$maxent_tss = as.numeric(maxent_res$tss$.estimate)
  }
  ...
  if (isTRUE(model$rf)) {
    ...
    summary_row$rf_tss = as.numeric(rf_res$tss$.estimate) 
  }
  ...
  if (isTRUE(model$brt)) {
    ...
    summary_row$brt_tss = as.numeric(brt_res$tss$.estimate) 
  }
  ...
  if (isTRUE(model$glm)) {
    ...
    summary_row$glm_tss = as.numeric(glm_res$tss$.estimate) 
  }
  ...
  if (isTRUE(model$nn)) {
    ...
    summary_row$nn_tss = as.numeric(nn_res$tss$.estimate) 
  }
