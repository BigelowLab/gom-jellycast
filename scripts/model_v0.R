...
# example:
# Rscript scripts/model_v0.R data/versions/v0/v0.001/v0.001.yaml 2015-06-01
# 
# params: 
...
main = function(cfg, target_date){
  root = cfg[["root"]]
  region = cfg[["region"]]
  poly = read_coastline_buffer(path = "/mnt/s1/projects/ecocast/projects/gom-jellycast-dev/data/polygons")
  species = cfg[["type"]]
