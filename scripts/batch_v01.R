...
# example:
# Rscript scripts/batch_v1.R 2025-07-08 \
# --configs data/versions/v0/v0.015/v0.015.yaml \
# data/versions/v0/v0.021/v0.021.yaml \
# data/versions/v0/v0.028/v0.028.yaml \
# data/versions/v0/v0.033/v0.033.yaml
# 
# params: 
